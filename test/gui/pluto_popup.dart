  ...
  void initState() {
    ...
    rows.addAll(
      List.generate(
        ...
        (i) => PlutoRow(
          cells: {
            'column_1': PlutoCell(value: 'Row ${i + 1} Col 1'),
            'column_2': PlutoCell(value: 'Row ${i + 1} Col 2'),
            'column_3': PlutoCell(value: 'Row ${i + 1} Col 3'),
            'column_4': PlutoCell(value: 'Row ${i + 1} Col 4'),
            'column_5': PlutoCell(value: 'Row ${i + 1} Col 5'),
          },
        ),
      ),
    );
