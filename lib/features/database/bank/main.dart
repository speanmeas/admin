...
class _Main_State extends State<Main_> {
  ...
  void init() async {
    ...
    if (tmp == null) return snackbar(ct: context, ms: "Error: ${endpoint.BANK_CRUD_READ_COUNT}", cl: Colors.red);
  ...
  void load_page(int p) async {
    ...
    if (tmp == null) return snackbar(ct: context, ms: "Error: ${endpoint.BANK_CRUD_READ}", cl: Colors.red);
