// * ទំព័រគ្រប់គ្រង mini bar សម្រាប់បង្កើត អាន កែ និងលុប
...
// * បង្កើត layout មេរបស់ទំព័រគ្រប់គ្រង mini bar
...
// * ថ្នាក់ state របស់ Main_ គ្រប់គ្រងទិន្នន័យ mini bar
class _Main_State extends State<Main_> {
  ...
  void load_page(int p) async {
    ...
    try {
      ...
      // * អានទិន្នន័យ mini bar តាម offset និង limit
      tmp = await dio.post(
        ...
        for (var d in data)
          PlutoRow(
            cells: {
              ...
              sm_mini_bar.ID: PlutoCell(value: d[sm_mini_bar.ID] ?? ""),
              sm_mini_bar.NAME: PlutoCell(value: d[sm_mini_bar.NAME] ?? ""),
              sm_mini_bar.PRICE: PlutoCell(value: d[sm_mini_bar.PRICE] ?? ""),
              sm_mini_bar.STOCK: PlutoCell(value: d[sm_mini_bar.STOCK] ?? ""),
              sm_mini_bar.NOTE: PlutoCell(value: d[sm_mini_bar.NOTE] ?? ""),
            },
          ),
      ]);
...
// * ថ្នាក់ Main_ ជាទំព័រគ្រប់គ្រង mini bar
