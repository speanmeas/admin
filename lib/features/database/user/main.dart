              ...
              return Center(
                child: SizedBox(
                  ...
                  child: FittedBox(
                    ...
                    child: Switch(
                      value: value,
                      onChanged: (v) => on_change_bool(rc, User.IS_ADMIN, v), //
                    ),
                  ),
                ),
              );
              ...
              return Center(
                child: SizedBox(
                  ...
                  child: FittedBox(
                    ...
                    child: Switch(
                      value: value,
                      onChanged: (v) => on_change_bool(rc, User.IS_MANAGER, v), //
                    ),
                  ),
                ),
              );
              ...
              return Center(
                child: SizedBox(
                  ...
                  child: FittedBox(
                    ...
                    child: Switch(
                      value: value,
                      onChanged: (v) => on_change_bool(rc, User.IS_RECEPTIONIST, v), //
                    ),
                  ),
                ),
              );
              ...
              return Center(
                child: SizedBox(
                  ...
                  child: FittedBox(
                    ...
                    child: Switch(
                      value: value,
                      onChanged: (v) => on_change_bool(rc, User.IS_HOUSEKEEPER, v), //
                    ),
                  ),
                ),
              );
