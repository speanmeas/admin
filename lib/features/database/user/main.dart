// * ទំព័រគ្រប់គ្រងអ្នកប្រើប្រាស់ (User) សម្រាប់បង្កើត អាន កែ និងលុប
...
class _Main_State extends State<Main_> {
  ...
  void init() async {
    try {
      //
      // * អានចំនួនអ្នកប្រើប្រាស់សរុប
      tmp = await dio.post(
        endpoint.USER_CRUD_READ_COUNT, //
        data: {"count": true},
      );
  ...
  void on_refresh() async {
    try {
      //
      // * អានចំនួនអ្នកប្រើប្រាស់សរុបឡើងវិញ
...
// * និយមន័យជួរឈររបស់តារាងអ្នកប្រើប្រាស់
final columns = [
  // * ជួរឈរលេខរៀង
  PlutoColumn(
    field: "index", //
  ...
  // * ជួរឈរតួនាទីជាអ្នកគ្រប់គ្រងប្រព័ន្ធ
  PlutoColumn(
