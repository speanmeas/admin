...
class _Main_State extends State<Main_> {
  ...
  void on_delete() async {
    ...
    tmp = await dio.post(endpoint.DEMO_2_CRUD_DELETE, data: {"_id": widget.id});
    setState(() => is_loading = false);
    if (tmp == null) return snackbar(ct: context, ms: "Error: ${endpoint.DEMO_2_CRUD_DELETE}", cl: Colors.red);
