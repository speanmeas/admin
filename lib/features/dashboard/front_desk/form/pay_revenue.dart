...
class _Main_State extends State<Main_> {
  ...
  void init() async {
    try {
      ...
      c_pay_cash.text = sm_fd.data[sm_fd.REVENUE_PAY_CASH]?["value"]?.toString() ?? "";
      c_pay_bank.text = sm_fd.data[sm_fd.REVENUE_PAY_BANK]?["value"]?.toString() ?? "";
    ...
    try {
      ...
      await dio.post(
        ...
        data: {
          ...
          sm_fd.REVENUE_PAY_CASH: pay_cash, //
          sm_fd.REVENUE_PAY_BANK: pay_bank, //
