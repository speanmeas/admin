...
class _Payment_State extends State<Payment_> {
  ...
  initState() {
    ...
    if (Model.paid_bank_usd != 0) controller_paid_bank_usd.text = Model.paid_bank_usd.toString();
    if (Model.paid_bank_khr != 0) controller_paid_bank_khr.text = Model.paid_bank_khr.toString();
    if (Model.paid_cash_usd != 0) controller_paid_cash_usd.text = Model.paid_cash_usd.toString();
    if (Model.paid_cash_khr != 0) controller_paid_cash_khr.text = Model.paid_cash_khr.toString();

    if (Model.return_usd != 0) controller_return_usd.text = Model.return_usd.toString();
    if (Model.return_khr != 0) controller_return_khr.text = Model.return_khr.toString();
  }
