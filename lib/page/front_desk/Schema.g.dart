...
final ROOM_PRICE_3H = "room_price_per_3h_usd";
...
// stay keys
final STAY_DAYS = "stay_duration_day";
final STAY_HOURS = "stay_duration_hour";
final STAY_NUM_GUESTS = "number_of_guests";
final SCHEDULE_CHECK_OUT = "schedule_check_out";

final CHECK_IN_BY_ID = "check_in_by_id";
final CHECK_IN_BY = "check_in_by";
final CHECK_IN_DATE = "check_in_at";
final CHECK_IN_NOTE = "check_in_note";

// payment keys
final PRICE_TOTAL = "price_total_usd";
final PRICE_DAY = "room_price_per_day_usd";
final PRICE_3H = "room_price_per_3h_usd";
...
final BALANCE_USD = "balance_total_usd";
