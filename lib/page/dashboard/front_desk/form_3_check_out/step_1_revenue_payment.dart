...
import "widget/input_revenue_price.dart" as input_revenue_price;
...
class _Main_State extends State<Main_> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: input_revenue_price.Main_(
                  initialValue: schema.data[schema.REVENUE_PRICE_TOTAL_USD]?["value"],
                  onChanged: (v) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: input_paid_bank_usd.Main_(
                        initialValue: schema.data[schema.REVENUE_PAID_BANK_USD]?["value"],
                        onChanged: (v) {
                    ...
                    Expanded(
                      child: input_paid_bank_khr.Main_(
                        initialValue: schema.data[schema.REVENUE_PAID_BANK_KHR]?["value"],
                        onChanged: (v) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: input_paid_cash_usd.Main_(
                        initialValue: schema.data[schema.REVENUE_PAID_CASH_USD]?["value"],
                        onChanged: (v) {
                    ...
                    Expanded(
                      child: input_paid_cash_khr.Main_(
                        initialValue: schema.data[schema.REVENUE_PAID_CASH_KHR]?["value"],
                        onChanged: (v) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: input_return_cash_usd.Main_(
                        initialValue: schema.data[schema.REVENUE_RETURN_USD]?["value"],
                        onChanged: (v) {
                    ...
                    Expanded(
                      child: input_return_cash_khr.Main_(
                        initialValue: schema.data[schema.REVENUE_RETURN_KHR]?["value"],
                        onChanged: (v) {
              ...
              Container(
                ...
                child: input_note.Main_(
                  initialValue: schema.data[schema.CHECK_OUT_NOTE]?["value"]?.toString(),
                  onChanged: (v) {
                    schema.data[schema.CHECK_OUT_NOTE]?["value"] = v;
                    setState(() {});
                  },
                ),
              ),
  ...
  double get_price_total_usd() {
    double price_total_usd = schema.data[schema.REVENUE_PRICE_TOTAL_USD]?["value"] ?? 0;
    return price_total_usd;
  }

  double get_paid_total_usd() {
    double paid_bank_usd = schema.data[schema.REVENUE_PAID_BANK_USD]?["value"] ?? 0;
    double paid_cash_usd = schema.data[schema.REVENUE_PAID_CASH_USD]?["value"] ?? 0;
    double paid_bank_khr = schema.data[schema.REVENUE_PAID_BANK_KHR]?["value"] ?? 0;
    double paid_cash_khr = schema.data[schema.REVENUE_PAID_CASH_KHR]?["value"] ?? 0;
  ...
  double get_return_total_usd() {
    double return_usd = schema.data[schema.REVENUE_RETURN_USD]?["value"] ?? 0;
    double return_khr = schema.data[schema.REVENUE_RETURN_KHR]?["value"] ?? 0;
