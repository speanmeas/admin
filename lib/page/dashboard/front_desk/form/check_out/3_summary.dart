...
class _Main_State extends State<Main_> {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                show_data.Main_(
                  title: "Checked-In At", //
                  value: _dateValue(fd_schema_r.data[fd_schema_r.CHECK_IN_AT]?["value"]),
                ),
                ...
                show_data.Main_(
                  ...
                  value: fd_schema_r.data[fd_schema_r.ROOM_PRICE_TOTAL_USD]?["value"]?.toString() ?? "",
                ),

                // room paid total
                show_data.Main_(
                  title: "Room Paid (USD)", //
                  value: fd_schema_r.data[fd_schema_r.ROOM_PAID_TOTAL_USD]?["value"]?.toString() ?? "",
                ),

                // room return total
                show_data.Main_(
                  title: "Room Returned (USD)", //
                  value: fd_schema_r.data[fd_schema_r.ROOM_RETURN_TOTAL_USD]?["value"]?.toString() ?? "",
                ),

                // room balance total
                show_data.Main_(
                  title: "Room Balanced (USD)", //
                  value: fd_schema_r.data[fd_schema_r.ROOM_BALANCE_TOTAL_USD]?["value"]?.toString() ?? "",
                ),

                // room paid note
                show_data.Main_(
                  title: "Room Payment Note", //
                  value: fd_schema_r.data[fd_schema_r.ROOM_PAID_NOTE]?["value"]?.toString() ?? "",
                ),
                ...
                // received room payment at
                show_data.Main_(
                  title: "Room Payment At", //
                  value: _dateValue(fd_schema_r.data[fd_schema_r.ROOM_PAID_AT]?["value"]),
                ),
  ...
  void on_check_in() async {
    try {
      ...
      //   if (e.value["value"] != null) print("${e.key}: ${e.value["value"]}");
      // }
      ...
      await dio.post(
        ...
        data: FormData.fromMap({
          ...
          r_schema_r.STATUS: "Pending Clean", //
        }),
      );
